...
/**
 * Created by Marcel Laptop on 14.09.2017.
 */
...
public final class QueryUtils {
    ...
    public static ArrayList<Earthquake> extractEarthquakes() {
        ...
        if (SAMPLE_JSON_RESPONSE != null) {
            try {
                //create a JSONObject with json string data
                JSONObject jsonObject = new JSONObject(SAMPLE_JSON_RESPONSE);

                //look for where the data is stored
                ...
                for (int i = 0; i < features.length(); i++) {
                    ...
                    // Properties node is JSON Object// in features find the properties
                    ...
                    // create a new earthquake object and populate it with the fetched data
                    Earthquake eq = new Earthquake(magnitude, location, time, url);

                    // add the new created earthquakes to the earthquakelist
                    earthquakes.add(i, eq);
                }
